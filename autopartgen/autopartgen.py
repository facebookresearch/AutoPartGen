...
from autopartgen.models.triposg.transformers.partgen_triposg_transformer import (
    PartgenTripoSGDiTModel,
)
...
DEFAULT_GUIDANCE = {
    "whole_cfg_scale": 5.0,
    "image": {"image_cfg_scale": 0.0, "geometry_cfg_scale": 5.0},
    "mesh": {"image_cfg_scale": 0.0, "geometry_cfg_scale": 5.0},
    "image_mesh": {"image_cfg_scale": 0.0, "geometry_cfg_scale": 5.0},
    "image_mask": {"image_cfg_scale": 7.0, "geometry_cfg_scale": 4.0},
    "image_mesh_mask": {"image_cfg_scale": 7.0, "geometry_cfg_scale": 4.0},
}
