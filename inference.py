...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="Iso-surface grid resolution (a power of two); use 256 for quick tests and 512 for final output.",
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    parser.add_argument("--iou_grid_size", type=int, default=512)
    parser.add_argument(
        "--duplicate_retries",
        type=int,
        default=3,
